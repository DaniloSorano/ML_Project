...
def plot_stats_reg(name,loss,val_loss=[],color = 'light',title=''):
    ...
    plt.plot(range(0,c),val_loss,linestyle='--',color=c2,label=('Test_loss average'if color!='light' else '')) 
